...
cl = LINETCR.LINE()
cl.login(token="Ep0LqTWKajux58kEoWCc.X1oqxzgsD4j3/DUxSnd6+a.fF+Y9N1HPrqA313slQTs64mG0cIa8/U8xAUqlxz/zDQ=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["\nYang punya akun masih patalan sama bapaknya Radisti☞ ",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pm Aja"]
                     ret_ = "Jiann Erammm " + random.choice(balas)
