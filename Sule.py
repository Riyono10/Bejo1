...
cl = LINETCR.LINE()
cl.login(token="EpRRTX9v3nUs3kNf6JU0.VDRtUpEtZJo3OC+vo9YYCa.g4pC5dgwii/zgk0JS1bUt00S7rOjlm1xWf7mDa5Rap4=")
cl.loginResult()
...
helpmsg ="""╔══════════════════════
║       [★ BOT COMMAND ★]
╠➩ Help1 [SOSMED COMMAND]
╠➩ Help2 [SETT COMMAND]
╠➩ Help3 [GROUP COMMAND]
╠➩ Help4 [SELF COMMAND]
╠➩ Help5 [PROTECT COMMAND]
╠➩ Mystatus
╠➩ Help1-Help5
╠➩ Promo
...
╠➩ ProtectBot Radii Versi Terbaru
╠➩ Pasang Siri V10 & V11
║     [👇 Minat Silahan hub👇]
╠➩ http://line.me/ti/p/H2VZm0LFeR
╠➩ http://line.me/ti/p/rGlnNi8lsn
╠➩ http://line.me/ti/p/~riyono10
╠➩ http://line.me/ti/p/4h4l2bwTVf
║  ═════════════════════
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [" Kangen ya Jangan Tag mulu\nKlo Kangen pc aja ☞   ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag?klo perlu penting Pc aja ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung PC Aja Guys ☞ ",cName + " Kenapa Tag saya?Klo penting PC Aja Bro ☞ "]
                     ret_ = "Nah gua Kena Tag " + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [" Ane lagi Anu Jangan Tag mulu ya\nKlo Penting pc aja ☞  ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag?klo perlu penting Pc aja ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung PC Aja Guys ☞ ",cName + " Kenapa Tag saya?Klo penting PC Aja Bro ☞ "]
                     ret_ = "Nape Brooo " + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
                     for mention in mentionees:
...
#==============================================================================#
		...
		if msg.from_ in creator:
                    ...
                    wait["cancelprotect"] = True                    
                    cl.sendText(msg.to,"Set Status Sudah Aktif Semua Already ON✔")
		else:
		    cl.sendText(msg.to,"Nah Set Status udah On smua")
		...
		if msg.from_ in creator:
                    ...
                    wait["cancelprotect"] = False                
                    cl.sendText(msg.to,"Set Status Sudah Di Nonaktifkan Semua OFF✔")
		else:
		    cl.sendText(msg.to,"Nah Set Status udah Off Smua")
                ...
                if wait["timeline"] == True: md+="║[★]Comment [On]\n"
                else:md+="║[★]Comment [Off]\n"
