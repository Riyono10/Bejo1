...
cl = LINETCR.LINE()
cl.login(token="EprbI1dxl0FMCK1naOFa.rhqZctF4XyggQSVpk9tpAG.20c5ayKHzWJNc0ErHiCyGBIGQNQBuOKFZ91x3aug41w=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     balas = [" Kangen ya Jangan Tag mulu\nKalo Kangen p c aja ☞ ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag? kalo perlu penting P c aja ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung P C Aja Coy ☞ ",cName + " Kenapa Tag saya? Kalo penting PC Aja Bro ☞ "]
