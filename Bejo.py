...
cl = LINETCR.LINE()
cl.login(token="EpWJkALROAiJsf6nWU56.fTKCLmFlBfpEHyAxbVypLG.uDuDGy+r4dKorZUnwMnIiI+c26qv4WK1CwHLbh6TXgc=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["\nNapa beb...bejo lgi ngopiii Kesel bar Resik2 kandang Bebek   "]
                     ret_ = "Semmm Ane Tag" + random.choice(balas)
