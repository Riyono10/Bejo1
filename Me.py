...
cl = LINETCR.LINE()
cl.login(token="EpllBaRhqWDfPk5Fnzt6.d0Y8Z+kWn1tqFy24ChaJ9G.mvYOVjNDvJXBOYnYf10QLENU9Y+/Y1CYUqjVUn43qso=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     balas = ["Ane lagi Anu Jangan Tag mulu ya\nKalo Penting P C aja ☞  ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag? kalo perlu penting Pc aja ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung P C Aja Coy ☞ ",cName + " Kenapa Tag saya? Kalo penting P C Aja Bro ☞ "]
                     ret_ = "Nape Bro " + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     cName = contact.displayName
                     image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                     balas = ["Ane lagi Anu Jangan Tag mulu ya\nKalo Penting P C aja ☞  ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag? kalo perlu penting P C aja ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung P C Aja Coy ☞ ",cName + " Kenapa Tag saya? Kalo penting P C Aja Bro ☞ "]
                     ret_ = "Nape Bro " + random.choice(balas)
                     tts = gTTS(text=ret_, lang='id')
                     tts.save('tts.mp3')
                     name = re.findall(r'@(\w+)', msg.text)
...
#==============================================================================#
            ...
            elif msg.text in ["Tagon"]:
		if msg.from_ in Creator:
                    wait["Tag"] = True
                    cl.sendText(msg.to,"Auto Tag Alrady ON✔")
		else:
		    cl.sendText(msg.to,"Khusus Creator")

            elif msg.text in ["Tagoff"]:
		if msg.from_ in Creator:
                    wait["Tag"] = False
                    cl.sendText(msg.to,"Auto Tag Already Off✔")
		else:
		    cl.sendText(msg.to,"Khusus Creator")
