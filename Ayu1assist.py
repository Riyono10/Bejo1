...
cl = LINETCR.LINE()
cl.login(token="EpWCrAdLvKJAuMoUKjAa.0sz4cJz1BblBZ9nZWYnmMG.zQNrHZWlDza9TXn7PMbhAAFb2x+CA81SgUmVWUWvWro=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Epvei5YLVBQtTbWiR13e.tP7k52qZazTrFC29WF9a7G.+a5LRyhFB4kW7qkOgNru+qGMvl2faXP/4MCcfgN/9rE")
ki.loginResult()
