...
cl = LINETCR.LINE()
cl.login(token="EpmX2rercJYjbzrG6Mga.q0ZUhecQjWOb4P2GDwpVUG.JKQeBi1O9y2LD7lnPGloLFukEyiUytC0YYfyAcQ7dGY=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     balas = [" Hay....sapa yang tag.....@¤{{☆@na☆}}¤ lagi sibuk....call aja kalo anu 😀😀😊😊 ☞  ",cName + " Aih..sapa nih yang tag aim........sabar ya aim lagi anu 😀😀 ☞ ",cName + " Tag lagi kk....aim cipok 😀😀 mauuu.....call aja ntar aim anuin 😀😀 ☞ ",cName + " Idih.....tag mulu kk....mau aim cipok ya.....😀😀 ☞ ",cName + " Kk .....kangen ya...tag aim mulu....sini aku anuin 😀😀 ☞ "]
                     ret_ = "Nah " + random.choice(balas)
