...
cl = LINETCR.LINE()
cl.login(token="Eps5bmGpHJf2IrsgqYg1.dJj0e9s4YdJfvpL/LKDrmq.flQmi2su+9gePMdPbdZLN5MAIc4UTjiCd77FWvwvzAM=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Para Laler ijo dilarang Bribik☞ ",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pm Aja"]
                     ret_ = "Aku Ditag Sopo " + random.choice(balas)
