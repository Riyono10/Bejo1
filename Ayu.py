...
cl = LINETCR.LINE()
cl.login(token="EpiLPYrFAbTSBeVIl84a.0sz4cJz1BblBZ9nZWYnmMG.urYAyXopJNt/50tR7iqsk3UoL+Ndmml1FdyNLxGFl7A=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpEzvIQB2Wvks0Bo2Iue.tP7k52qZazTrFC29WF9a7G.SCqEW28O4rFrl6+iqdpqfaq4jKnO0D+koRg6VSJ6kS4=")
ki.loginResult()
