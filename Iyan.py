...
cl = LINETCR.LINE()
cl.login(token="Epyuxop42YZlzXsD4TB9.aoXHl3tyoa77feCUBXhUYq.LMI2EkgFZKelpDd9G/aWIQVzW2PfGriY7PRjMXldM2Q=")
cl.loginResult()
    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["\nKangen ya klo kangen pm aja ya   "]
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
            cl.sendText(op.param1,"Hello Kakak ☞ " + cl.getContact(op.param2).displayName +" ☜"+ "\nWELCOME TO ☞ " + str(ginfo.name) + " ☜" + "\nBudayakan Baca Note Ya kak\nDilarang Nikung No Baper\nSemoga Betah Disini Salam Cipok😘😘😘")
