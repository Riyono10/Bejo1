        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [" Dalem kakak Ada yg bisa Saya bantu😊😊 ☞  ",cName + " Dont Tag Me!! Im Busy\nberisik aku sibuk ☞ ",cName + " Stop tag.. Don't distrub me ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung PC Aja Kak ☞ ",cName + " Kenapa Tag saya?Klo penting PC Aja Kak ☞ "]
                     ret_ = "Sapa yang tag " + random.choice(balas)
