...
cl = LINETCR.LINE()
cl.login(token="EpLed79JfxvoLYA0ECN4.v3159rqs/s56knnGYJuA5a.ees8vADbe6G87dKZQhYcMysaxkB9ac/Ehu8aurZX4os=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["  lagi semedi mumet mikir bot☞   ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag?klo perlu penting Pc aja ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung PC Aja Guys ☞ ",cName + " Kenapa Tag saya?Klo penting PC Aja Bro ☞ "]
                     ret_ = "aisshh" + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["  Sujar lagi mumet mikir bot ☞  ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag?klo perlu penting Pc aja ☞ ",cName + " Nggak Usah Tag-Tag mulu!!Kalo Penting Langsung PC Aja Guys ☞ ",cName + " Kenapa Tag saya?Klo penting PC Aja Bro ☞ "]
                     ret_ = "aisshh" + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
