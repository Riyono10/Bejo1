...
cl = LINETCR.LINE()
cl.login(token="Ep5o17hQ6Ii0nzkZrZg1.iUHJZ0j5T3IIvIQExFOp4q.tzU6hpuZEVhe+ydxsq+uSyWIOQMymrtEVd5lpGeXsno=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [" o(>ω< )ZÁKÜRÁ(>ω< )oNANTI AQ LAPORIN\nBUNDA PUTRIE BIAR DIPINALTY. ☞ ",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pm Aja"]
                     ret_ = "JANGAN TAG " + random.choice(balas)
