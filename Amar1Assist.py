...
cl = LINETCR.LINE()
cl.login(token="EpfvWkFupdUeHQYdfpO4.clVazarVXFKXZFfW5H5cXa.diRF/FYyvkFLSGktMowzFs5IcBkdqi2y8mK8fa1xiho=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpzWu4r8SA6zotzLSTQc.HqHW/UfwYCwtG3w17K1+Ra.wIh+iDJ4aoAIRu4Fj4cpJ+L7oO2Pnj6DVRhXr9yJkQw=")
ki.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     balas = [" Aku masih Sibuk Jangan Tag dulu ya\nKlo Penting pc aja ya ☞   ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag Kak?\nKlo perlu penting Pc aja ya ☞ ",cName + " Nggak Usah Tag-Tag mulu!!\nKalo Penting Langsung PC Aja Kak ☞ ",cName + " Kenapa Tag Aku kak?\nKlo penting PC Aja Ya ☞ "]
                     ret_ = "Iya kak " + random.choice(balas)
