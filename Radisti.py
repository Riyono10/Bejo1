...
cl = LINETCR.LINE()
cl.login(token="Eocgm0AbLbqv9hYlMLN1.dJj0e9s4YdJfvpL/LKDrmq.HEM7NHBIeSaNuYvVuJKHjpIXWXiQeKDKaIMB+gV0hYU=")
cl.loginResult()
    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["\nSek Rizanya Lagi Mojok Ojo Tag Tag Mulu Tak Cipok Mubeng Lho!!! "]
                     ret_ = "[Sopo Tag Aku???] " + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pm Aja","Hemmm aku lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid':'u0e327413d4b8c838c554f97e96475131',"}
                cl.sendMessage(msg)
