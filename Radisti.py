...
cl = LINETCR.LINE()
cl.login(token="Ep7mijnHEMZAHaUnMPE8.fjSIf69Wywe4OCILM+Z4Qa.oThZwjmBDMEQlQ9JxWC4hfEr2E9xfrTTj1QQlsooTh4=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["\nYang punya akun masih patalan sama bapaknya Radisti ☞ ",cName + " Ngapain Ngetag to? Sek bentar sibuk masak ☞ ",cName + " Nggak Usah Tag-Tag! Kalo Penting P C bojoku aja ☞ "]
                     ret_ = "Jian Eram " + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     cName = contact.displayName
                     image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                     balas = ["\nYang punya akun masih patalan sama bapaknya Radisti ☞ ",cName + " Ngapain Ngetag to? sek aku sibuk masak ☞ ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung P C Bojoku Aja"]
                     ret_ = "Jian Eram " + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     tts = gTTS(text=ret_, lang='id')
                     tts.save('tts.mp3')
